...
public class deleteFromDB extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		playerToDelete.setFirstName(request.getParameter("firstName"));
		playerToDelete.setLastName(request.getParameter("lastName"));
		System.out.println(playerToDelete.getFirstName() + " " + playerToDelete.getLastName());
		DAO.deleteFromDB(playerToDelete);
	}
